...
const CompleteTask = ({data}) => {
  return (
     <div className="flex-shrink-0 h-full w-[350px] bg-blue-300 rounded-xl p-3">
              ...
              <div className='mt-2'>
                 <button className='w-full cursor-pointer bg-green-500 py-2 px-2 rounded text-sm' >Complete</button>
              </div>
        </div>
  )
}
